...
namespace quadrotors
{
    ...
    constexpr Scalar rotor_time_constant_up_range[2] = {rotor_time_constant_up_real * 0.2, rotor_time_constant_up_real * 2};
    constexpr Scalar rotor_time_constant_down_real = 0.025;
    constexpr Scalar rotor_time_constant_down_range[2] = {rotor_time_constant_down_real * 0.2, rotor_time_constant_down_real * 2};
    constexpr Scalar rotor_moment_constant_real = 0.016;
    constexpr Scalar rotor_moment_constant_range[2] = {rotor_moment_constant_real * 0.2, rotor_moment_constant_real * 2};
    ...
    constexpr Scalar inertia_range[3][2] = {{inertia_real[0] * 0.2, inertia_real[0] * 2},
                                            {inertia_real[1] * 0.2, inertia_real[1] * 2},
                                            {inertia_real[2] * 0.2, inertia_real[2] * 2}};
    constexpr Scalar vel_drag_factor_real = 0.1;
    constexpr Scalar vel_drag_factor_range[2] = {vel_drag_factor_real * 0.2, vel_drag_factor_real * 2};
    constexpr Scalar omega_drag_factor_real = 4e-4;
    constexpr Scalar omega_drag_factor_range[2] = {omega_drag_factor_real * 0.2, omega_drag_factor_real * 2};
