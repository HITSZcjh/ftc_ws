...
namespace quadrotors
{
    ...
    constexpr Scalar g_real = 9.81;
    constexpr Scalar g_range[2] = {g_real * 0.999, g_real * 1.001};
    constexpr Scalar rotor_time_constant_up_real = 0.025;
    constexpr Scalar rotor_time_constant_up_range[2] = {rotor_time_constant_up_real * 0.2, rotor_time_constant_up_real * 1.8};
    constexpr Scalar rotor_time_constant_down_real = 0.025;
    constexpr Scalar rotor_time_constant_down_range[2] = {rotor_time_constant_down_real * 0.2, rotor_time_constant_down_real * 1.8};
    constexpr Scalar rotor_moment_constant_real = 0.016;
    constexpr Scalar rotor_moment_constant_range[2] = {rotor_moment_constant_real * 0.2, rotor_moment_constant_real * 1.8};
    constexpr Scalar body_length_real = 0.125;
    constexpr Scalar body_length_range[2] = {body_length_real * 0.7, body_length_real * 1.3};
    constexpr Scalar mass_real = 0.732;
    constexpr Scalar mass_range[2] = {mass_real * 0.7, mass_real * 1.3};
    constexpr Scalar inertia_real[3] = {0.005, 0.003, 0.01};
    constexpr Scalar inertia_range[3][2] = {{inertia_real[0] * 0.2, inertia_real[0] * 1.8},
                                            {inertia_real[1] * 0.2, inertia_real[1] * 1.8},
                                            {inertia_real[2] * 0.2, inertia_real[2] * 1.8}};
    constexpr Scalar vel_drag_factor_real = 0.1;
    constexpr Scalar vel_drag_factor_range[2] = {vel_drag_factor_real * 0.2, vel_drag_factor_real * 1.8};
    constexpr Scalar omega_drag_factor_real = 4e-4;
    constexpr Scalar omega_drag_factor_range[2] = {omega_drag_factor_real * 0.2, omega_drag_factor_real * 1.8};
    ...
    public:
        ...
        inline Scalar gaussian_random(const Scalar &min, const Scalar &max)
        {
